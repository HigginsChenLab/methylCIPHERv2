...
groups are too large, so their weights live in downloadable assets.

This vignette shows how
[methylCIPHERv2](https://github.com/HigginsChenLab/methylCIPHERv2)
resolves the assets directory, and how to change it.
...
empties the directory. It lists the assets and asks for confirmation,
and it takes `ask` like the two verbs above.
